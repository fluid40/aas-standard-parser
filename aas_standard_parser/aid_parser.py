...
def create_property_to_href_map(aid_interface: SubmodelElementCollection) -> Dict[str, PropertyDetails]:
...
def parse_security(aid_interface: SubmodelElementCollection) -> IAuthenticationDetails:
